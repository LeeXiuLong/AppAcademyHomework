...
class MetaCorgiSnacks
  ...
  def method_missing(name, *args)
    # Your code goes here...
    info_string = 'get_' + name.to_s + '_info'
    tastiness_string = 'get_' + name.to_s + '_tastiness'
    info = @snack_box.send(info_string, @box_id)
    tastiness = @snack_box.send(tastiness_string, @box_id)
